...
CREATE TABLE `personal_trainer_service` (
  ...
  KEY `FK_PT_service_idx` (`ID_service`),
  CONSTRAINT `FK_PT` FOREIGN KEY (`ID_PT`) REFERENCES `personal_trainer` (`ID`),
  CONSTRAINT `FK_PT_service` FOREIGN KEY (`ID_service`) REFERENCES `service` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `personal_trainer_service` VALUES (1,1),(1,2),(2,2),(2,3),(3,4),(1,5),(3,5),(2,6),(3,7);
...
INSERT INTO `staff_role` VALUES (7,1,'2024-12-01','Active','Huấn luyện viên cá nhân chuyên về dinh dưỡng'),(9,2,'2023-11-15','Active','Gym Manager - Quản lý toàn bộ phòng gym.'),(9,7,'2023-10-20','Unactive','Customer Support - Nhân viên chăm sóc khách hàng.'),(10,1,'2023-10-10','Unactive','Huấn luyện viên cá nhân chuyên về thể hình.'),(10,4,'2023-11-11','Active','Maintenance Staff - Nhân viên bảo trì cơ sở vật chất.'),(11,1,'2023-09-25','Active','Huấn luyện viên cá nhân chuyên về yoga.'),(12,1,'2023-11-01','Active','Huấn luyện viên cá nhân chuyên về boxing.'),(13,3,'2023-12-05','Active','Receptionist - Nhân viên lễ tân.'),(14,5,'2023-09-15','Active','Sales Consultant - Tư vấn viên bán hàng.');
...
-- Dump completed on 2024-12-01 18:57:10
